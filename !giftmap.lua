        ...
        lua_thread.create(
          function()
            ...
            if map_ico["x" .. tostring(gift_string)] == nil then
              print("Обнаружен новый подарок", model, pos.x, pos.y, pos.z)
              local message = {
